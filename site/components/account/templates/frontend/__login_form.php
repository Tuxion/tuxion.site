...
<form method="post" action="<?php echo url('action=cms/login/post'); ?>"  id="login_form">
  ...
  <section>
    ...
    <div class="ctrlHolder clearfix">
      <label for="l_username"><?php __('Email address'); ?></label>
      <input id="l_username" type="text" name="email" value="" placeholder="" />
    </div>

    <div class="ctrlHolder clearfix">
      <label for="l_password"><?php __('Password'); ?></label>
      <input id="l_password" type="password" name="pass" value="" placeholder="" />
    </div>
