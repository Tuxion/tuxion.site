...
<?php if(tx('Account')->check_level(2)): ?>
  <ul id="topbar_menu">
    ...
    -->
    <li class="advanced-edit"><a href="<?php echo $admin_toolbar->advanced_url; ?>">Advanced Edit</a></li>
    <li class="advanced"><a href="<?php echo $admin_toolbar->admin_url; ?>">Control Panel</a></li>
  </ul>
<?php endif; ?>